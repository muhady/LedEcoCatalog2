//----------------------------------------------------------------------------
// <copyright file="AssemblyInfo.cs" company="Binaware">
...
/// <summary>
/// Provides properties for getting the information about the application.
/// </summary>
internal static partial class AssemblyInfo
{
  ...
  /// The assembly title.
  /// </summary>
  public const string Title = Product + " Web Application";

  /// <summary>
  /// The file version.
  /// </summary>
  public const string FileVersion = Version + ".0.0";
}
